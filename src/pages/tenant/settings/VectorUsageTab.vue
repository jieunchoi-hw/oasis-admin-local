  ...
  <div>
    ...
    <div class="d-flex justify-space-between align-center mb-4">
      <div class="text-body-2 text-medium-emphasis">
        ■ System Admin에 의해 배정된 Vector DB 중 사용할 Vector DB를 설정한다.
      </div>
    ...
    <div class="d-flex gap-4" style="height: 600px">
      ...
      <div class="flex-grow-1 d-flex flex-column">
        <div class="d-flex align-center justify-space-between mb-3">
          <div class="d-flex align-center">
            <div class="text-body-2 ms-1">
              System Admin에 의해 배정된 Vector DB
            </div>
          </div>
      ...
      <div class="flex-grow-1 d-flex flex-column">
        <div class="d-flex align-center justify-space-between mb-3">
          <div class="d-flex align-center">
            <div class="text-body-2 ms-1">현재 사용하는 Vector DB</div>
          </div>
          <div class="d-flex align-center gap-2 me-3">
            <VBtn variant="text" size="small"> 전체선택 </VBtn>
